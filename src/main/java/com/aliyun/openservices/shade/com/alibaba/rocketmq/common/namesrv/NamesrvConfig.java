...
public class NamesrvConfig {
    ...
    /**
     * Indicates the nums of thread to handle REGISTER_BROKER requests
     */
    private int registerBrokerThreadPoolNums = 32;
    /**
     * Indicates the nums of thread to handle broker or operation requests.
     */
    ...
    /**
     * Indicates the capacity of queue to hold REGISTER_BROKER requests.
     */
    private int registerBrokerThreadPoolQueueCapacity = 5000;
    /**
     ...
     * 3. support pull related operations, such as pop, ack, changeInvisibleTime, etc.
     * 4. support query earliest msg store time.
     */
    private boolean supportActingMaster = false;

    private volatile boolean enableAllTopicList = false;

    private boolean registerFastFailureEnable = true;

    private long waitTimeMillsInSendQueue = 5 * 1000L;
    ...
    public int getRegisterBrokerThreadPoolNums() {
        return registerBrokerThreadPoolNums;
    }

    public void setRegisterBrokerThreadPoolNums(final int registerBrokerThreadPoolNums) {
        this.registerBrokerThreadPoolNums = registerBrokerThreadPoolNums;
    }
    ...
    public int getRegisterBrokerThreadPoolQueueCapacity() {
        return registerBrokerThreadPoolQueueCapacity;
    }

    public void setRegisterBrokerThreadPoolQueueCapacity(final int registerBrokerThreadPoolQueueCapacity) {
        this.registerBrokerThreadPoolQueueCapacity = registerBrokerThreadPoolQueueCapacity;
    }
    ...
    public boolean isRegisterFastFailureEnable() {
        return registerFastFailureEnable;
    }

    public void setRegisterFastFailureEnable(boolean registerFastFailureEnable) {
        this.registerFastFailureEnable = registerFastFailureEnable;
    }
