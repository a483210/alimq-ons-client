...
public class MessageQueue implements Comparable<MessageQueue>, Serializable {
    ...
    private int queueId;
    private volatile int queueGroupId = NO_QUEUE_GROUP;
    ...
    public MessageQueue(String topic, String brokerName, int queueId, int queueGroupId, boolean mainQueue) {
    ...
    public static class MessageQueueKeySerializer extends StdSerializer<MessageQueue> {

        public MessageQueueKeySerializer() {
            super(MessageQueue.class);
        }

        @Override
        public void serialize(MessageQueue value, JsonGenerator gen, SerializerProvider provider) throws IOException {
            gen.writeFieldName(JsonUtils.toJson(value));
        }
    }

    public static class MessageQueueKeyDeserializer extends KeyDeserializer {
        @Override
        public Object deserializeKey(String key, DeserializationContext ctxt) throws IOException {
            return JsonUtils.readValue(key, MessageQueue.class);
        }
    }
}
