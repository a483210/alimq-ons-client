...
public class DataVersion extends RemotingSerializable {
    ...
    public DataVersion(long counter) {
        this.setCounter(new AtomicLong(counter));
    }

    public void reset(final DataVersion dataVersion) {
    ...
    public boolean equals(final Object o) {
        ...
        if (stateVersion != that.stateVersion) {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        int result = (int) (stateVersion ^ (stateVersion >>> 32));
