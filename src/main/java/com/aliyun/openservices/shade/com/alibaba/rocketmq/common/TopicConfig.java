...
public class TopicConfig {
    ...
    public TopicConfig(TopicConfig another) {
        this.topicName = another.topicName;
        this.readQueueNums = another.readQueueNums;
        this.writeQueueNums = another.writeQueueNums;
        this.perm = another.perm;
        this.topicFilterType = another.topicFilterType;
        this.topicSysFlag = another.topicSysFlag;
