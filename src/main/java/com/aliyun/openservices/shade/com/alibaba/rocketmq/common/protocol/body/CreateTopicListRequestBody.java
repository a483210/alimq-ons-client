...
public class CreateTopicListRequestBody extends RemotingSerializable {
    ...
    public CreateTopicListRequestBody(List<TopicConfig> topicConfigList, List<QueueGroupConfig> queueGroupConfigList) {
        this.topicConfigList = topicConfigList;
        this.queueGroupConfigList = queueGroupConfigList;
    }
    ...
    public List<QueueGroupConfig> getQueueGroupConfigList() {
        return queueGroupConfigList;
    }

    public void setQueueGroupConfigList(List<QueueGroupConfig> queueGroupConfigList) {
        this.queueGroupConfigList = queueGroupConfigList;
    }
}
