...
public class DefaultLitePullConsumerImpl implements MQConsumerInner {
    ...
    public long committed(MessageQueue messageQueue) throws MQClientException {
        ...
        try {
            optionalOffset = this.offsetStore.readOffset(messageQueue, ReadOffsetType.MEMORY_FIRST_THEN_STORE);
        } catch (Throwable t) {
            throw new MQClientException("Failed to read offset", t);
        }
        // TODO: return optional directly in next release.
    ...
    public void removeTopicSubscribeInfo(String topic) {
        if (!this.defaultLitePullConsumer.isAutoCleanTopicRouteNotFound()) {
            return;
        }
