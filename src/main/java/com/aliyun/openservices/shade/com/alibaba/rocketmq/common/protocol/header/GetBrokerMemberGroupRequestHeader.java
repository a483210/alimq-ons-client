...
public class GetBrokerMemberGroupRequestHeader implements CommandCustomHeader {
    ...
    public void checkFields() throws RemotingCommandException {
        if (clusterName == null) {
            throw new RemotingCommandException("GetBrokerMemberGroupRequest exception, clusterName is null");
        }

        if (brokerName == null) {
            throw new RemotingCommandException("GetBrokerMemberGroupRequest exception, brokerName is null");
        }
    }
}
