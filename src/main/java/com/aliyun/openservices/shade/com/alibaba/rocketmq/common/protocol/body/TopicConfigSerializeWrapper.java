...
public class TopicConfigSerializeWrapper extends RemotingSerializable {
    ...
    private ConcurrentMap<String, QueueGroupConfig> queueGroupConfigTable =
        new ConcurrentHashMap<String, QueueGroupConfig>();
    ...
    public ConcurrentMap<String, QueueGroupConfig> getQueueGroupConfigTable() {
        return queueGroupConfigTable;
    }

    public void setQueueGroupConfigTable(
        ConcurrentMap<String, QueueGroupConfig> queueGroupConfigTable) {
        this.queueGroupConfigTable = queueGroupConfigTable;
    }
}
