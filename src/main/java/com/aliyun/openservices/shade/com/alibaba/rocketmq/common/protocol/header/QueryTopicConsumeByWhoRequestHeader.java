...
public class QueryTopicConsumeByWhoRequestHeader implements CommandCustomHeader {
    ...
    private boolean historicalAccepted;

    @Override
    public void checkFields() throws RemotingCommandException {
        if (Strings.isNullOrEmpty(topic)) {
            throw new RemotingCommandException("Topic is unexpected being null or empty");
        }
    }
    ...
    public boolean isHistoricalAccepted() {
        return historicalAccepted;
    }

    public void setHistoricalAccepted(boolean historicalAccepted) {
        this.historicalAccepted = historicalAccepted;
    }
}
