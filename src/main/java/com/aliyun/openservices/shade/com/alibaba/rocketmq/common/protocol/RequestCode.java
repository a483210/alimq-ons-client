...
public class RequestCode extends RemotingCopyElisionRequestCode {
    ...
    public static final int CHECK_BROKER_CONNECTIVITY = 62;
    ...
    /**
     * pull metric data from client
     */
    public static final int PULL_METRIC_DATA = 403;
    ...
    /**
     * Below request codes are used by leaderless ha arch,
