...
public class MessageConst {
    ...
    public static final String PROPERTY_MSHA_TRANSFORM = "MSHA_TRANSFORM";
    ...
    public static final String PROPERTY_QUEUEGROUP_SNAPSHOT = "QUEUEGROUP_SNAPSHOT";
    public static final String PREFIX_HA_ORDER_MQ_OFFSET = "HA_ORDER_MQ_OFFSET/";
    ...
    /**
     * the transient property key of MSHA_RETRY (set by msha client and remove by broker)
     */
    public static final String PROPERTY_TRANSIENT_MSHA_RETRY = PROPERTY_TRANSIENT_PREFIX + "MSHA_RETRY";


    public static final String KEY_SEPARATOR = " ";

    public static final HashSet<String> STRING_HASH_SET = new HashSet<String>();
    public static final HashSet<String> PROPERTY_NAME_PREFIX_SET = new HashSet<String>();
    ...
    static {
        ...
        STRING_HASH_SET.add(PROPERTY_FQN_TOPIC);
        ...
        STRING_HASH_SET.add(PROPERTY_DECODED_TIMESTAMP);
        ...
        STRING_HASH_SET.add(PROPERTY_QUEUEGROUP_SNAPSHOT);
        STRING_HASH_SET.add(PROPERTY_TRANSIENT_MSHA_RETRY);
        STRING_HASH_SET.add(PROPERTY_MSHA_TRANSFORM);
        PROPERTY_NAME_PREFIX_SET.add(PREFIX_HA_ORDER_MQ_OFFSET);
    }

    public static String withPrefix(String prefix, String value) {
        return prefix + value;
    }
}
