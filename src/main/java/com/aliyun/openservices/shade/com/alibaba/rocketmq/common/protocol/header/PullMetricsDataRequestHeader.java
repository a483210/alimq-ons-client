...
public class PullMetricsDataRequestHeader implements CommandCustomHeader {
    // To prohibit that more than one metric data in remoting module are pulled from broker, we need to use token to
