...
public class PopMessageRequestHeader implements CommandCustomHeader {
    ...
    /**
     * the field is valid only when {@link PopMessageRequestHeader#queueId} is set to -1
     * the content "0,1,2,3" represents that this request is try to pop the queueId 0, 1, 2, 3 in the broker
     */
    private String queueIdListString;
    ...
    public String getQueueIdListString() {
        return queueIdListString;
    }

    public List<Integer> parseQueueIdListString() {
        if (queueIdListString == null || queueIdListString.isEmpty()) {
            return Collections.emptyList();
        }
        try {
            List<Integer> queueIdList = new ArrayList<Integer>();
            String[] queueIdStringList = queueIdListString.split(",");
            for (String queueIdString : queueIdStringList) {
                int queueId = Integer.parseInt(queueIdString);
    ...
    public void setQueueIdListString(String queueIdListString) {
        this.queueIdListString = queueIdListString;
    }
}
