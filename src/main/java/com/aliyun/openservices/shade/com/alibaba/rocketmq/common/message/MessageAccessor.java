...
public class MessageAccessor {
    ...
    public static void putHAOrderMessageQueueOffset(final Message msg, String key, String offset) {
        putProperty(msg, MessageConst.withPrefix(MessageConst.PREFIX_HA_ORDER_MQ_OFFSET, key), offset);
    }

    public static String getHAOrderMessageQueueOffset(final Message msg, String key) {
        return msg.getProperty(MessageConst.withPrefix(MessageConst.PREFIX_HA_ORDER_MQ_OFFSET, key));
    }

    public static void putQueueGroupSnapshot(final Message msg, String value) {
        putProperty(msg, MessageConst.PROPERTY_QUEUEGROUP_SNAPSHOT, value);
    }

    public static String getQueueGroupSnapshot(final Message msg) {
        return msg.getProperty(MessageConst.PROPERTY_QUEUEGROUP_SNAPSHOT);
    }
